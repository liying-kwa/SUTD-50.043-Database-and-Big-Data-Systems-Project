...
/opt/sqoop-1.4.7/bin/sqoop import-all-tables --connect jdbc:mysql://ec2-122-248-220-104.ap-southeast-1.compute.amazonaws.com/mydb?useSSL=false --username userall2 --password password2 --fields-terminated-by "\t" --as-parquetfile -m1
